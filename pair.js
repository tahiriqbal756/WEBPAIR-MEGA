        ...
        try {
            ...
            GlobalTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'Hacker-tf-MD~' + stringSession;  // Prepend your name to the session ID
